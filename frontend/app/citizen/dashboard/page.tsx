...
export default function CitizenDashboardPage() {
      ...
      <div className="bg-[#FFFDD0] min-h-screen flex flex-row">
        ...
        <div className="flex-1 ml-0 md:ml-72 p-6 md:p-12 bg-[radial-gradient(#000_1px,transparent_1px)] [background-size:24px_24px]">
          <div className="animate-pulse space-y-6">
            <div className="h-10 bg-gray-300 w-48 border-4 border-black"></div>
  ...
  return (
    <div className="bg-[#FFFDD0] min-h-screen flex flex-row">
      ...
      <div className="flex-1 ml-0 md:ml-72 p-6 md:p-12 bg-[radial-gradient(#000_1px,transparent_1px)] [background-size:24px_24px]">
        <h1 className="text-[48px] font-extrabold uppercase mb-6">Dashboard</h1>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-white border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h3 className="text-[14px] uppercase font-bold">Total Reports</h3>
          ...
          <div className="bg-[#facc15] border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h3 className="text-[14px] uppercase font-bold">Pending</h3>
          ...
          <div className="bg-blue-400 border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h3 className="text-[14px] uppercase font-bold">In Progress</h3>
          ...
          <div className="bg-[#22C55E] border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
            <h3 className="text-[14px] uppercase font-bold">Resolved</h3>
            <p className="text-6xl font-black mt-4">{stats?.resolved || 0}</p>
          </div>
        </div>

        <Link href="/citizen/submit">
          <button className="bg-[#22C55E] border-4 border-black px-12 py-6 text-2xl font-bold uppercase mb-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            + SUBMIT NEW REPORT
          </button>
        </Link>

        <h2 className="text-2xl font-bold uppercase mb-4">Recent Reports</h2>
